...
public class Experience_verte {
    ...
    public static void main(String[] args){
        ...
        System.out.println ("Entrée des quantitées ...");
        System.out.print ("A > ");
        A = sc.nextInt();
        System.out.print ("B > ");
        B = sc.nextInt();
        ...
        D = (D+(k1*3));
        CO2 = (CO2+k1);
        System.out.println("A_1{" + A + "} B_1{" + B + "} C_1{" + C + "} D_1{" + D + "} E_1{" + E + "} F_1{" + F + "} CO2_1{" + CO2 + "}");
        ...
        F = F + (k2*4);
        CO2 = CO2 + (k2*4);
        System.out.println("A_2{" + A + "} B_2{" + B + "} C_2{" + C + "} D_2{" + D + "} E_2{" + E + "} F_2{" + F + "} CO2_2{" + CO2 + "}");
        ...
        E = E + (k3*4);
        CO2 = CO2 + (k3);
        System.out.println("A_3{" + A + "} B_3{" + B + "} C_3{" + C + "} D_3{" + D + "} E_3{" + E + "} F_3{" + F + "} CO2_3{" + CO2 + "}");
